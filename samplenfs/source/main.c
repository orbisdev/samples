...
void browserDraw()
{
	...
	while(entry && i<MAX_ENTRIES)
	{
		...
		orbisGlTextDraw(entry->dir->name,60,90+i*30+1+67-30,color);
		...
		orbisGlTextDraw(dateString,740+960+8-15-35,90+i*30+1+67-30,color);
		//orbisGlTextDraw(" hello world",740+960+8-15-35,90+i*30+1+67-30,color);

		orbisGlTextDraw(unitString,740+960-8-15-35-22*2,90+i*30+1+67-30,color);
		orbisGlTextDraw(sizeString,740+960-8-15-35-22*7,90+i*30+1+67-30,color);
	...
	orbisGlTextDraw(mypath,30,52+76-30+2,color);
}
